...
def write snippet, to:
  if snippet.nil? then return end

  begin
    File.write(to, snippet, mode: 'a')
  rescue => exception
    puts "An exception was raised whilst trying to write to #{to}. Exception: #{exception}"
  end
end
...
def compile file, output_language
  ...
  if output_language == "php"
    ...
    write "# Generated by Yakima", to: file_to_write_to
  else
  ...
  lines.each do |line|
    ...
    expressions.each do |expression|
      ...
      write snippet, to: file_to_write_to
    end
  end
...
def handleEmbeddedYakima file, language
  ...
  puts "Perfect! Your new file has been generated. It's named #{File.basename(file, ".*")}.php"
end
